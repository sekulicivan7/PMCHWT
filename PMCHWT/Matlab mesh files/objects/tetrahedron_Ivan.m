% A regular tetrahedron is built
%
% param(1)  -----> side length
% param(2)  -----> steps on the side
%
% The basis of the tetrahedron lies on the plane XY
%
% by Ed. Ubeda, February 2016

function obj = tetrahedron_Ivan(param)
...
n_2_3_4_0 = length( obj.vertex );

vert_face_2_3_4 = [];
for m=3:N,
    tmp_vec = ( vert_edge_2_4(:,m) - vert_edge_2_3(:,m) )/(m-1); 
    vert_edge_tmp = vert_edge_2_3(:,m) * ones(1,m-2) +   tmp_vec * [ 1 : (m-2) ];
    obj.vertex = [ obj.vertex  vert_edge_tmp ];
end;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% DEFINITION IF TRIANGLES %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 1st row 
tmp_topol = [ fst_vert_1_2_3    vert_line_1_3(1)  vert_line_1_2(1) ].';
% 2nd row
tmp_topol = [ tmp_topol [ vert_line_1_2(1)   (n_prev_1 + 1)   vert_line_1_2(2) ].' ...
                        [ vert_line_1_3(1)   (n_prev_1 + 1)   vert_line_1_2(1)  ].' ...
                        [ vert_line_1_3(1)   vert_line_1_3(2)   (n_prev_1 + 1) ].' ];
...
for m=3:N
    ...
    if (m~=N),
        ...
        %% First-row triangles
        tmp_topol = [ tmp_topol [ vert_line_1_2(m-1)   (n_prev_1 + 1)  vert_line_1_2(m)].' ...
                                [ vert_line_1_2(m-1)   (n_prev_0 + 1)  (n_prev_1 + 1)    ].'   ];
        ...
        %% End-row triangles
        tmp_topol = [ tmp_topol [       n_prev_1     vert_line_1_3(m-1) (n_prev_1 + (m-1)) ].' ...
                                [ (n_prev_1 + (m-1))  vert_line_1_3(m-1)  vert_line_1_3(m)  ].'  ];                
    ...
    elseif (m==N),
        ...
        tmp_topol = [ tmp_topol [ vert_line_1_2(N-1)   vert_line_2_3(1) n_vert_2 ].' ...
                                [ vert_line_1_2(N-1) (n_prev_0+1) vert_line_2_3(1) ].'     ];
        ...
        tmp_topol = [ tmp_topol     [  vert_line_2_3(N-1)  (n_prev_0 + (N-2))  vert_line_1_3(N-1)   ].'     ...
                                    [  vert_line_1_3(N-1)       n_vert_3       vert_line_2_3(N-1)   ].'    ];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 1st row 
tmp_topol = [ fst_vert_1_3_4  vert_line_1_4(1)  vert_line_1_3(1)].';
% 2nd row
tmp_topol = [ tmp_topol [ vert_line_1_3(1)  (n_prev_1 + 1)  vert_line_1_3(2) ].' ...
                        [ vert_line_1_3(1)  vert_line_1_4(1)  (n_prev_1 + 1) ].' ...
                        [ vert_line_1_4(1)  vert_line_1_4(2)  (n_prev_1 + 1) ].' ];
...
for m=3:N
    ...
    if (m~=N),
        ...
        %% First-row triangles
        tmp_topol = [ tmp_topol [ vert_line_1_3(m-1)  (n_prev_1 + 1)  vert_line_1_3(m) ].' ...
                                [ vert_line_1_3(m-1)  (n_prev_0 + 1) (n_prev_1 + 1)  ].'   ];
        ...
        %% End-row triangles
        tmp_topol = [ tmp_topol [ (n_prev_1 + (m-1))        n_prev_1        vert_line_1_4(m-1) ].' ...
                                [ (n_prev_1 + (m-1))    vert_line_1_4(m-1)   vert_line_1_4(m)   ].'  ];                
    ...
    elseif (m==N),
        ...
        tmp_topol = [ tmp_topol [ vert_line_1_3(N-1)  vert_line_3_4(1) n_vert_3].' ...
                                [ vert_line_1_3(N-1)   (n_prev_0+1)  vert_line_3_4(1)].'     ];
        ...
        %% Last-row end-triangles
        tmp_topol = [ tmp_topol     [  (n_prev_0 + (N-2))    vert_line_1_4(N-1) vert_line_3_4(N-1)  ].'     ...
                                    [  vert_line_1_4(N-1)      n_vert_4        vert_line_3_4(N-1)   ].'    ];
...
% 1st row 
tmp_topol = [ fst_vert_1_4_2  vert_line_1_2(1) vert_line_1_4(1)  ].';
% 2nd row
tmp_topol = [ tmp_topol [ vert_line_1_4(1)   (n_prev_1 + 1)   vert_line_1_4(2) ].' ...
                        [ vert_line_1_4(1)  vert_line_1_2(1)  (n_prev_1 + 1) ].' ...
                        [ vert_line_1_2(1)  vert_line_1_2(2)  (n_prev_1 + 1) ].' ];
...
for m=3:N
    ...
    if (m~=N),
        ...
        %% First-row triangles
        tmp_topol = [ tmp_topol [ vert_line_1_4(m)   vert_line_1_4(m-1)  (n_prev_1 + 1) ].' ...
                                [  (n_prev_1 + 1)    vert_line_1_4(m-1)  (n_prev_0 + 1) ].'   ];
        ...
        %% End-row triangles
        tmp_topol = [ tmp_topol [   (n_prev_1 + (m-1))     n_prev_1           vert_line_1_2(m-1) ].' ...
                                [   vert_line_1_2(m)   (n_prev_1 + (m-1))     vert_line_1_2(m-1) ].'  ];                
    ...
    elseif (m==N),
        ...
        tmp_topol = [ tmp_topol [ vert_line_1_4(N-1)  vert_line_4_2(1)  n_vert_4].' ...
                                [ vert_line_1_4(N-1)   (n_prev_0+1)   vert_line_4_2(1) ].'     ];
        ...
        %% Last-row end-triangles
        tmp_topol = [ tmp_topol     [  (n_prev_0 + (N-2))  vert_line_1_2(N-1)  vert_line_4_2(N-1)   ].'     ...
                                    [  vert_line_1_2(N-1)      n_vert_2        vert_line_4_2(N-1)   ].'    ];
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%%  TRIANGLE : 4th face: 2_3_4  %%  1_2_3 => 2_3_4 ;  1_2 => 2_3 ; 1_3 => 2_4 ; 2_3 => 3_4 ; n_vert_2 => n_vert_3 ; n_vert_3 => n_vert_4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 1st row 
tmp_topol = [ fst_vert_2_3_4 vert_line_2_3(1) vert_line_2_4(1) ].';
% 2nd row
tmp_topol = [ tmp_topol [ vert_line_2_3(1)  vert_line_2_3(2)  (n_prev_1 + 1) ].' ...
                        [ vert_line_2_3(1)   (n_prev_1 + 1)  vert_line_2_4(1) ].' ...
                        [ vert_line_2_4(1)   (n_prev_1 + 1)  vert_line_2_4(2) ].' ];
...
for m=3:N
    ...
    if (m~=N),
        ...
        %% First-row triangles
        tmp_topol = [ tmp_topol [ vert_line_2_3(m-1)  vert_line_2_3(m)  (n_prev_1 + 1) ].' ...
                                [ vert_line_2_3(m-1)   (n_prev_1 + 1)   (n_prev_0 + 1) ].'   ];
        ...
        %% End-row triangles
        tmp_topol = [ tmp_topol [       n_prev_1        (n_prev_1 + (m-1))   vert_line_2_4(m-1) ].' ...
                                [ (n_prev_1 + (m-1))     vert_line_2_4(m)    vert_line_2_4(m-1) ].'  ];                
    ...
    elseif (m==N),
        ...
        tmp_topol = [ tmp_topol [ vert_line_2_3(N-1) n_vert_3 vert_line_3_4(1) ].' ...
                                [ vert_line_2_3(N-1) vert_line_3_4(1) (n_prev_0+1) ].'     ];
                       
        %% Mid-row end-triangles
        for n=1:N-2,
            tmp_topol = [ tmp_topol [ (n_prev_0 + n)  vert_line_3_4(n) vert_line_3_4(n+1) ].' ];
            
            if ( n~=(N-2) ),  
                tmp_topol = [ tmp_topol  [  (n_prev_0 + n) vert_line_3_4(n+1) (n_prev_0 + (n+1)) ].'  ]; 
            end;
        end;  %% for n=1:N-2,
        
        %% Last-row end-triangles
        tmp_topol = [ tmp_topol     [  (n_prev_0 + (N-2))  vert_line_3_4(N-1)  vert_line_2_4(N-1)   ].'     ...
                                    [  vert_line_2_4(N-1)  vert_line_3_4(N-1)  n_vert_4  ].'    ];
